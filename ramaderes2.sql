...
#SELECT DISTINCT * FROM tipus_explotacio WHERE  in ('engreix', 'producció de cicle tancat', 'engreix per consum humà', 'altres');

#SELECT DISTINCT especie, classif_zootecnica FROM tipus_explotacio;
